...
class LanguageProvider with ChangeNotifier {
  ...
  Map<String, Object> textsAr = {
    ...
    "Steps": "الخطوات",
    "favorites_text": "لم تقم بأضافة طعام مفضل لحد الآن - قم بأضافة بعض الاطعمة!",
    "ingredients-m1": [
      "4 طماطم",
  ...
  Map<String, Object> textsEn = {
    ...
    "Steps": "Steps",
    "favorites_text": "you don't have any favorite meal yet.",
    "ingredients-m1": ['4 Tomatoes', '1 Tablespoon of Olive Oil', '1 Onion', '250g Spaghetti', 'Spices', 'Cheese (optional)'],
    "ingredients-m2": ['1 Slice White Bread', '1 Slice Ham', '1 Slice Pineapple', '1-2 Slices of Cheese', 'Butter'],
    "ingredients-m3": ['300g Cattle Hack', '1 Tomato', '1 Cucumber', '1 Onion', 'Ketchup', '2 Burger Buns'],
    "ingredients-m4": ['8 Veal Cutlets', '4 Eggs', '200g Bread Crumbs', '100g Flour', '300ml Butter', '100g Vegetable Oil', 'Salt', 'Lemon Slices'],
    "ingredients-m5": ['Arugula', 'Lamb\'s Lettuce', 'Parsley', 'Fennel', '200g Smoked Salmon', 'Mustard', 'Balsamic Vinegar', 'Olive Oil', 'Salt and Pepper'],
    "ingredients-m6": [
    ...
    "ingredients-m10": ['White and Green Asparagus', '30g Pine Nuts', '300g Cherry Tomatoes', 'Salad', 'Salt, Pepper and Olive Oil'],
    "steps-m1": [
    ...
    "steps-m2": ['Butter one side of the white bread', 'Layer ham, the pineapple and cheese on the white bread', 'Bake the toast for round about 10 minutes in the oven at 200°C'],
    "steps-m3": [
      'Form 2 patties',
    ...
    "steps-m5": ['Wash and cut salad and herbs', 'Dice the salmon', 'Process mustard, vinegar and olive oil into a dessing', 'Prepare the salad', 'Add salmon cubes and dressing'],
    "steps-m6": [
